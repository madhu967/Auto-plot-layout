...
const styles = StyleSheet.create({
  headerOuter: {
    paddingBottom: Platform.OS === 'web' ? 4 : 4.5,
    paddingHorizontal: Platform.OS === 'web' ? 0 : 2.5,
    ...
    position: 'relative',
    shadowColor: '#000000',
    shadowOffset: { width: 0, height: Platform.OS === 'web' ? 2 : 5 },
    shadowOpacity: Platform.OS === 'web' ? 0.08 : 0.18,
    shadowRadius: Platform.OS === 'web' ? 5 : 10,
    elevation: Platform.OS === 'web' ? 3 : 10,
  },
  headerContainer: {
    paddingHorizontal: 18,
    paddingTop: Platform.OS === 'ios' ? 48 : (Platform.OS === 'android' ? (StatusBar.currentHeight || 24) + 4 : (Platform.OS === 'web' ? 12 : 20)),
    paddingBottom: Platform.OS === 'web' ? 12 : 8,
    borderBottomLeftRadius: Platform.OS === 'web' ? 0 : 36,
    borderBottomRightRadius: Platform.OS === 'web' ? 0 : 36,
    overflow: 'hidden',
  },
  headerBody: {
    flexDirection: 'row',
